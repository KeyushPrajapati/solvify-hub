...
// normal message for client to reviewer - Solvify
...
// normal message for client to Hoster - Solvify
...
if(document.getElementById("reviewer_offer_btn_1")){
    document.querySelectorAll('[id^="reviewer_offer_btn_"]').forEach((e)=>{
        const identifier = e.id.split("_")[3];
        const badge = document.querySelector(`#reviewer_requested_badge_${identifier}`);
        e.addEventListener("click",()=>{
            Swal.fire({
                title: 'Are you sure ?',
                text: 'You want to Offer',
